"""build_corpus.py — rulează env L10 și salvează programele care aduc bins noi.

Usage:
    python build_corpus.py --episodes 300 --out corpus_l10.json
    python build_corpus.py --episodes 300 --model l10_checkpoint_model.zip --out corpus_l10.json
"""
...
from codec_l10 import emit_program
from env_l10 import IbexL10Env, run_program
...
def main():
    ...
    ap.add_argument("--out",      default="corpus_l10.json")
    ap.add_argument("--seed",     type=int, default=42)
    args = ap.parse_args()

    np.random.seed(args.seed)
    env = IbexL10Env(episode_steps=args.steps)
