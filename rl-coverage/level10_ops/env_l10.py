"""env_l10.py — L10 env, identic cu L9 V2 dar cu 87 ops.

Față de env_l9_v2.py:
  - codec_l10: 87 ops (83 L9 + ILLEGAL_INSN + LW_MISALIGN + SW_MISALIGN + LH_MISALIGN)
  - Action space: MultiDiscrete([87, 32, 32, 32, 5])
  - Obs space identic: 32 dims
...
PROGRAM_JSON = "/tmp/rl_l10.json"

sys.path.insert(0, str(L5))
import cov_parser

from codec_l10 import N_OPS, IMM_BUCKETS, emit_program
