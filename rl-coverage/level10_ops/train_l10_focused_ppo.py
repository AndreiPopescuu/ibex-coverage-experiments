...
Usage:
    ...
    python train_l10_focused_ppo.py --resume --episodes 3600
"""
...
from env_l10_focused import IbexL10FocusedEnv, MODULES, N_OBS
...
CKPT_MODEL   = THIS / "l10_focused_checkpoint_model"
CKPT_HITS    = THIS / "l10_focused_checkpoint_hits.pkl"
CKPT_HISTORY = THIS / "l10_focused_checkpoint_history.npz"
...
def main():
    ...
    ap.add_argument("--out",      default="l10_focused_ppo_curve.npz")
    ap.add_argument("--resume",   action="store_true")
    ap.add_argument("--hits",     default=None,
                    help="Hits din L9 (l9_v2_checkpoint_hits.pkl)")
