"""replay_corpus.py — replays corpus L10 și raportează coverage final.

Regression test: dacă coverage-ul replayat atinge pragul așteptat, testul trece.

Usage:
    python replay_corpus.py --corpus corpus_l10.json
    python replay_corpus.py --corpus corpus_l10.json --expected 70.0
"""
...
PROGRAM_JSON = "/tmp/rl_l10_replay.json"
...
def main():
    ...
    print(f"Corpus: {total_prg} programe | coverage așteptat: {corpus['final_cum_pct']}%\n")
