"""env_l9_v1.py — L9 env cu obs space mic (10 dims), ca env_l8_dynamic.

Obs layout (10 dims):
  [0]     step_idx / episode_steps
  [1]     cum_hits / total_toggles
  [2..9]  coverage fraction per modul (8 module urmărite)

Reward: weight = 1 / coverage_fraction (dinamic, per modul).
...
PROGRAM_JSON = "/tmp/rl_l9_v1.json"
...
N_OBS = 2 + len(TRACKED_MODULES)  # 10
