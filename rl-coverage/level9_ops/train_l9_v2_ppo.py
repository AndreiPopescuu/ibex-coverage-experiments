"""train_l9_v2_ppo.py — PPO pe L9 cu obs space extins (32 dims).

Configurație:
  - IbexL9V2Env: 83 ops, obs 32 dims (25 module + step + cum + n_ep + hist4)
  - net_arch: [512, 256]
  - ent_coef: 0.08

Features:
  - Checkpoint automat la fiecare 100 episoade
  - Ctrl+C salvează și iese curat
  - --resume continuă din ultimul checkpoint
...
# ── Checkpoint paths ──────────────────────────────────────────────────────────
CKPT_MODEL   = THIS / "l9_v2_checkpoint_model"
CKPT_HITS    = THIS / "l9_v2_checkpoint_hits.pkl"
CKPT_HISTORY = THIS / "l9_v2_checkpoint_history.npz"
...
def main():
    ...
    cb._load_corpus()
    cb.history = history_prev  # istoricul anterior dacă facem resume
