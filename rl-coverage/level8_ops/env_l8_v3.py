"""env_l8_v3.py — L8 env cu obs space extins (34 dims).

Față de env_l8_dynamic.py:
  - 27 module urmărite (nu doar 8; ibex_counter_P1 exclus: MHPMCounterNum=0)
...
Obs layout (34 dims):
  ...
  [3..29] coverage fraction per modul (27 module)
  [30..33] ultimele 4 opcode-uri alese, normalizate prin N_OPS
"""
...
HIST_LEN    = 4
N_OBS       = 3 + N_MODULES + HIST_LEN  # = 34 (ibex_counter_P1 exclus: MHPMCounterNum=0)
MAX_EP_NORM = 500.0
