"""Level 8 rich-observation env for PPO.
...
Identical contract to env_l7_rich but uses codec_l8 (70 ops) and
test_run_for_l8 (all-registers prologue + extended trap handler).
"""
