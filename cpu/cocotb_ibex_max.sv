...
//
// "Maximum" Ibex configuration variant of cocotb_ibex.sv — every optional
// feature enabled, for exploring the toggle-coverage bins that are tied off
// (or simply absent) in the minimal build (cocotb_ibex.sv).
// Build with: make CONFIG=max
